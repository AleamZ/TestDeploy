              ...
              <>
                <div className="Render-HightLight-Pd-cpn">
                  <p className="Render-HightLight-Pd-title">
                    {item.categoryName.toUpperCase()} NỔI BẬT NHẤT
                  </p>
                  <div className="Render-HightLight-Pd-list-tag">
                    {item.brands.map(
                      (brand: {
                        ...
                        return (
                          <div className="Render-HightLight-Pd-tag">
                            {brand.name}
                          </div>
                        );
                      }
                ...
                >
                  {item.products.map((product: any, index: any) => {
                    ...
                    const cardData: CardInfor = {
                      ...
                      cardPrice: salePrice || price || undefined, // Hiển thị salePrice nếu có, không thì hiển thị price
                      cardOriginalPrice: salePrice
                        ? price ?? undefined
